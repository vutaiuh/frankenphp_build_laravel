<!DOCTYPE html>
<html><head><title>Create Post</title><script src="https://cdn.tailwindcss.com"></script></head>
    ...
    <form action="{{ route('posts.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea name="content" rows="5"
                class="w-full border rounded px-3 py-2 @error('content') border-red-400 @enderror">{{ old('content') }}</textarea>
